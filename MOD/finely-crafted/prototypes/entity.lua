...
add_entity({
    ...
    icon = "__finely-crafted-graphics__/graphics/chemical-stager/chemical-stager-icon.png",
    icon_size = 64,
    selection_box = box6,
    graphics_set = {
        animation = {
...
add_entity({
    name = "lumber-mill",
    icon = "__finely-crafted-graphics__/graphics/lumber-mill/lumber-mill-icon.png",
    icon_size = 64,
    selection_box = box7,
    graphics_set = {
        animation = {
        ...
        working_visualisations = {
            {
                ...
                animation = {
                    ...
                    stripes = {
                        {
                            filename = "__finely-crafted-graphics__/graphics/lumber-mill/lumber-mill-hr-emission-1.png",
                            width_in_frames = 8,
                            height_in_frames = 8,
                        },
                        {
                            filename = "__finely-crafted-graphics__/graphics/lumber-mill/lumber-mill-hr-emission-2.png",
                            width_in_frames = 8,
                            height_in_frames = 8,
                        },
                    },
