...
circuit_connector_definitions["nixie-triplet"] = circuit_connector_definitions.create
(
  universal_connector_template,
  {
...
data:extend{
  ...
  },
  {
    type = "item",
    name = "nixie-tube",
    icon = "__NixieTubesThreeDigits__/graphics/nixie-base-icon.png",
    icon_size = 32,
  ...
  },
  {
    ...
    picture_off =
    {
      filename = "__NixieTubesThreeDigits__/graphics/nixie-base.png",
      priority = "high",
    ...
    picture_on =
    {
      filename = "__NixieTubesThreeDigits__/graphics/empty.png",
      priority = "high",
      width = 1,
      height = 1,
      shift = {0,0}
  ...
  },
  {
    type = "item",
    name = "nixie-tube-alpha",
    icon = "__NixieTubesThreeDigits__/graphics/nixie-alpha-base-icon.png",
    icon_size = 32,
    subgroup = "circuit-network",
    order = "c-a",
  ...
  },
  {
    type = "item",
    name = "nixie-tube-small",
    icon = "__NixieTubesThreeDigits__/graphics/nixie-small-base-icon.png",
    icon_size = 32,
    subgroup = "circuit-network",
    order = "c-a",
  ...
  },
  {
    ...
    picture_off =
    {
      filename = "__NixieTubesThreeDigits__/graphics/nixie-small-base.png",
      priority = "high",
  ...
  },
  {
    type = "item",
    name = "nixie-tube-triplet",
    icon = "__NixieTubesThreeDigits__/graphics/nixie-triplet-base-icon.png",
    icon_size = 32,
    subgroup = "circuit-network",
    order = "c-a",
  ...
  },
  {
    ...
    icon_size = 32,
    flags = {"placeable-neutral","player-creation", "not-on-map"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "nixie-tube-triplet"},
    max_health = 40,
    order = "z[zebra]",
    corpse = "small-remnants",
    ...
    picture_off =
    {
      filename = "__NixieTubesThreeDigits__/graphics/nixie-triplet-base.png",
      priority = "high",
    ...
    circuit_wire_connection_point = circuit_connector_definitions["nixie-triplet"].points,
    circuit_connector_sprites = circuit_connector_definitions["nixie-triplet"].sprites,
  },
}
...
function nixie_sprite(char,xoffset,yoffset)
  return   {
      ...
      filename = "__NixieTubesThreeDigits__/graphics/nixie-chars-mono.png",
